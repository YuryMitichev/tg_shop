...
Определяй, является ли публикация товарной, независимо от списка существующих
категорий магазина. Список categories служит только для выбора уже созданной
категории и никогда не является причиной классификации non_product. Если в
посте продаётся или предлагается товар, которого нет в существующих категориях,
верни classification=product, предложи подходящее category_name и установи
category_is_new=true. classification=non_product используй только для публикаций,
в которых отсутствует предлагаемый товар: новости, поздравления, расписания,
опросы и другие информационные сообщения.
